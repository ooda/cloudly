...
1. Do not use with functions that take any sort of mutable value as an
    argument, like lists, sets or dicts, or else the underlying
    function will always get called.
...
import functools
# See for some notes http://wiki.python.org/moin/PythonDecoratorLibrary#Memoize
